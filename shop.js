...
if (x==20) {
 ...
 else {alert("Not enough items; " + numberShortAlert(game.coins) + "/25000 coins, " + game.enemies[6] + "/3 Stone boys beaten, " + game.enemies[9] + "/1 Magma boys beaten")
 itemChosen = 0}
 }
}
if (x==21) {
...
if (x==36) {
 ...
 if (x==0) {document.getElementById("shopInfo").innerHTML = ""}
  ...
  if (x==1) {document.getElementById("shopInfo").innerHTML = "<br><br><center><p style='color: white'><span style='font-size: 32px; font-weight: bold'>" + items[x][0] + "</span><br>You got " + game.items[x] + "/" + items[x][1] + "</p><br><img src='img/shop/" + x + ".png' style='width: 50%'><br><p style='color: white'></span>Cost:<br>" + numberShort(game.coins) + "/50 Coins<br>" + game.pets[1] + "/20 Green butterflies<br><br>Effects:<br>+50% XP gain</p></center>"}
     if (x == 2) { document.getElementById("shopInfo").innerHTML = "<br><br><center><p style='color: white'><span style='font-size: 32px; font-weight: bold'>" + items[x][0] + "</span><br>You got " + game.items[x] + "/" + items[x][1] + "</p><br><img src='img/shop/" + x + ".png' style='width: 50%'><br><p style='color: white'></span>Cost:<br>" + numberShort(game.coins) + "/100 Coins<br>" + game.pets[10] + "/5 Gargoyles<br><br>Effects:<br>+25% Stats gain</p></center>"}
     if (x == 3) { document.getElementById("shopInfo").innerHTML = "<br><br><center><p style='color: white'><span style='font-size: 32px; font-weight: bold'>" + items[x][0] + "</span><br>You got " + game.items[x] + "/" + items[x][1] + "</p><br><img src='img/shop/" + x + ".png' style='width: 50%'><br><p style='color: white'></span>Cost:<br>" + numberShort(game.coins) + "/150 Coins<br>" + game.pets[43] + "/1 Golden butterfly<br><br>Effects:<br>+25% XPBoost gain</p></center>"}
     if (x == 4) { document.getElementById("shopInfo").innerHTML = "<br><br><center><p style='color: white'><span style='font-size: 32px; font-weight: bold'>" + items[x][0] + "</span><br>You got " + game.items[x] + "/" + items[x][1] + "</p><br><img src='img/shop/" + x + ".png' style='width: 50%'><br><p style='color: white'></span>Cost:<br>" + numberShort(game.coins) + "/200 Coins<br>" + game.pets[3] + "/20 Rats<br>" + game.pets[18] + "/5 Cats<br>" + game.pets[24] + "/5 Shiny rats<br><br>Effects:<br>+2% Faster cooldowns</p></center>"}
     if (x == 5) { document.getElementById("shopInfo").innerHTML = "<br><br><center><p style='color: white'><span style='font-size: 32px; font-weight: bold'>" + items[x][0] + "</span><br>You got " + game.items[x] + "/" + items[x][1] + "</p><br><img src='img/shop/" + x + ".png' style='width: 50%'><br><p style='color: white'></span>Cost:<br>" + numberShort(game.coins) + "/250 Coins<br>" + game.pets[5] + "/10 Glowing spiders<br>" + game.pets[16] + "/3 Living roses<br><br>Effects:<br>+30% Fighting rewards</p></center>"}
     if (x == 6) { document.getElementById("shopInfo").innerHTML = "<br><br><center><p style='color: white'><span style='font-size: 32px; font-weight: bold'>" + items[x][0] + "</span><br>You got " + game.items[x] + "/" + items[x][1] + "</p><br><img src='img/shop/" + x + ".png' style='width: 50%'><br><p style='color: white'></span>Cost:<br>" + numberShort(game.coins) + "/500 Coins<br>-Beat (Armored Human)<br>" + game.enemies[5] + "/1 Armored humans beaten<br><br>Effects:<br>-Unlock a new area (focused on coin drops)</p></center>"}
     if (x == 7) { document.getElementById("shopInfo").innerHTML = "<br><br><center><p style='color: white'><span style='font-size: 32px; font-weight: bold'>" + items[x][0] + "</span><br>You got " + game.items[x] + "/" + items[x][1] + "</p><br><img src='img/shop/" + x + ".png' style='width: 50%'><br><p style='color: white'></span>Cost:<br>" + numberShort(game.coins) + "/500 Coins<br>" + game.pets[41] + "/5 Eyeloons<br>" + game.pets[42] + "/3 Glowing jellyfishes<br><br>Effects:<br>+75% XPBoost</p></center>"}
     if (x == 8) { document.getElementById("shopInfo").innerHTML = "<br><br><center><p style='color: white'><span style='font-size: 32px; font-weight: bold'>" + items[x][0] + "</span><br>You got " + game.items[x] + "/" + items[x][1] + "</p><br><img src='img/shop/" + x + ".png' style='width: 50%'><br><p style='color: white'></span>Cost:<br>" + numberShort(game.coins) + "/500 Coins<br>" + game.pets[4] + "/20 Purple butterflies<br>" + game.pets[23] + "/7 Blue butterflies<br><br>Effects:<br>+100% XP gain</p></center>"}
     if (x == 9) { document.getElementById("shopInfo").innerHTML = "<br><br><center><p style='color: white'><span style='font-size: 32px; font-weight: bold'>" + items[x][0] + "</span><br>You got " + game.items[x] + "/" + items[x][1] + "</p><br><img src='img/shop/" + x + ".png' style='width: 50%'><br><p style='color: white'></span>Cost:<br>" + numberShort(game.coins) + "/750 Coins<br>" + game.pets[14] + "/15 Large tortoises<br>" + game.pets[25] + "/5 Earth snakes<br><br>Effects:<br>+75% Stats gain</p></center>"}
     if (x == 10) { document.getElementById("shopInfo").innerHTML = "<br><br><center><p style='color: white'><span style='font-size: 32px; font-weight: bold'>" + items[x][0] + "</span><br>You got " + game.items[x] + "/" + items[x][1] + "</p><br><img src='img/shop/" + x + ".png' style='width: 50%'><br><p style='color: white'></span>Cost:<br>" + numberShort(game.coins) + "/250 Coins<br>-Own (Green dragon)<br>" + game.pets[6] +"/1 Green dragons<br><br>Effects:<br>-Crates will only have popups if it's a new pet discovered</p></center>"}
     if (x == 11) { document.getElementById("shopInfo").innerHTML = "<br><br><center><p style='color: white'><span style='font-size: 32px; font-weight: bold'>" + items[x][0] + "</span><br>You got " + game.items[x] + "/" + items[x][1] + "</p><br><img src='img/shop/" + x + ".png' style='width: 50%'><br><p style='color: white'></span>Cost:<br>" + numberShort(game.coins) + "/1000 Coins<br>" + game.pets[33] + "/5 Poisonous eyeballs<br>" + game.pets[29] + "/1 Spirit (2nd level only)<br><br>Effects:<br>+90% Fighting rewards</p></center>"}
     if (x == 12) { document.getElementById("shopInfo").innerHTML = "<br><br><center><p style='color: white'><span style='font-size: 32px; font-weight: bold'>" + items[x][0] + "</span><br>You got " + game.items[x] + "/" + items[x][1] + "</p><br><img src='img/shop/" + x + ".png' style='width: 50%'><br><p style='color: white'></span>Cost:<br>" + numberShort(game.coins) + "/2000 Coins<br>" + game.XPBoost + "/201 XPBoost<br>" + game.pets[9] + "/20 Eldritch eyeballs<br>" + game.pets[32] + "/10 Red slimes<br>" + game.pets[48] + "/3 Small skeletons<br><br>Effects:<br>+200% XPBoost<br>-Softcap exponent +^0.05</p></center>"}
     if (x == 13) { document.getElementById("shopInfo").innerHTML = "<br><br><center><p style='color: white'><span style='font-size: 32px; font-weight: bold'>" + items[x][0] + "</span><br>You got " + game.items[x] + "/" + items[x][1] + "</p><br><img src='img/shop/" + x + ".png' style='width: 50%'><br><p style='color: white'></span>Cost:<br>" + numberShort(game.coins) + "/1500 Coins<br>" + game.pets[1] + "/50 Green butterflies<br>" + game.pets[12] + "/2 Red butterflies<br>" + game.pets[43] + "/1 Golden butterfly<br><br>Effects:<br>+200% XP gain</p></center>"}
     if (x == 14) { document.getElementById("shopInfo").innerHTML = "<br><br><center><p style='color: white'><span style='font-size: 32px; font-weight: bold'>" + items[x][0] + "</span><br>You got " + game.items[x] + "/" + items[x][1] + "</p><br><img src='img/shop/" + x + ".png' style='width: 50%'><br><p style='color: white'></span>Cost:<br>" + numberShort(game.coins) + "/1750 Coins<br>" + game.pets[17] + "/5 Ice golems<br>" + game.pets[35] + "/5 Living trees<br>" + game.pets[19] + "/2 Vortex monsters<br><br>Effects:<br>+150% Fighting stats</p></center>"}
     if (x == 15) { document.getElementById("shopInfo").innerHTML = "<br><br><center><p style='color: white'><span style='font-size: 32px; font-weight: bold'>" + items[x][0] + "</span><br>You got " + game.items[x] + "/" + items[x][1] + "</p><br><img src='img/shop/" + x + ".png' style='width: 50%'><br><p style='color: white'></span>Cost:<br>" + numberShort(game.coins) + "/2000 Coins<br>" + game.pets[40] + "/25 Small elfs<br>" + game.enemies[1] + "/10 Small humanoids beaten<br>" + game.enemies[4] + "/2 Nordic grandfathers beaten<br><br>Effects:<br>-The 4 basic pet crates try to be opened every 30 minutes automatically</p></center>"}
     if (x == 16) { document.getElementById("shopInfo").innerHTML = "<br><br><center><p style='color: white'><span style='font-size: 32px; font-weight: bold'>" + items[x][0] + "</span><br>You got " + game.items[x] + "/" + items[x][1] + "</p><br><img src='img/shop/" + x + ".png' style='width: 50%'><br><p style='color: white'></span>Cost:<br>" + numberShort(game.coins) + "/1750 Coins<br>" + game.pets[2] + "/75 Green lizards<br>" + game.pets[7] + "/30 Snakes<br>" + game.pets[15] + "/10 Mutant tarantulas<br><br>Effects:<br>-The 4 basic crates unbox an extra pet every time it opens<br>-The skeleton/ghost crates also unbox an extra pet every time</p></center>"}
     if (x == 17) { document.getElementById("shopInfo").innerHTML = "<br><br><center><p style='color: white'><span style='font-size: 32px; font-weight: bold'>" + items[x][0] + "</span><br>You got " + game.items[x] + "/" + items[x][1] + "</p><br><img src='img/shop/" + x + ".png' style='width: 50%'><br><p style='color: white'></span>Cost:<br>" + numberShort(game.coins) + "/2500 Coins<br>" + game.pets[8] + "/20 Giant fireflies<br>" + game.pets[36] + "/1 Fire spectral<br>" + game.pets[28] + "/1 Lilypad<br><br>Effects:<br>+220% Fighting rewards</p></center>"}
     if (x == 18) { document.getElementById("shopInfo").innerHTML = "<br><br><center><p style='color: white'><span style='font-size: 32px; font-weight: bold'>" + items[x][0] + "</span><br>You got " + game.items[x] + "/" + items[x][1] + "</p><br><img src='img/shop/" + x + ".png' style='width: 50%'><br><p style='color: white'></span>Cost:<br>" + numberShort(game.coins) + "/5000 Coins<br>" + game.pets[56] + "/5 Ghost rodents<br>" + game.pets[49] + "/3 Skeletal dogs<br>" + game.pets[37] + "/1 Purple star<br><br>Effects:<br>-XPBoost affects DailyXP at a reduced rate<br>-Any item that multiplies xp also works for daily xp</p></center>"}
     if (x == 19) { document.getElementById("shopInfo").innerHTML = "<br><br><center><p style='color: white'><span style='font-size: 32px; font-weight: bold'>" + items[x][0] + "</span><br>You got " + game.items[x] + "/" + items[x][1] + "</p><br><img src='img/shop/" + x + ".png' style='width: 50%'><br><p style='color: white'></span>Cost:<br>" + numberShort(game.coins) + "/15000 Coins<br>" + game.pets[64] + "/3 Infected spiders<br>" + game.pets[65] + "/1 Red snake<br><br>Effects:<br>x2 XP (additive with itself, multiplicative with others)</p></center>" }
     if (x == 20) { document.getElementById("shopInfo").innerHTML = "<br><br><center><p style='color: white'><span style='font-size: 32px; font-weight: bold'>" + items[x][0] + "</span><br>You got " + game.items[x] + "/" + items[x][1] + "</p><br><img src='img/shop/" + x + ".png' style='width: 50%'><br><p style='color: white'></span>Cost:<br>" + numberShort(game.coins) + "/25000 Coins<br>" + game.enemies[6] + "/3 Stone boys beaten<br>" + game.enemies[9] + "/1 Magma boys beaten<br><br>Effects:<br>x2 Stats</p></center>" }
     if (x == 21) { document.getElementById("shopInfo").innerHTML = "<br><br><center><p style='color: white'><span style='font-size: 32px; font-weight: bold'>" + items[x][0] + "</span><br>You got " + game.items[x] + "/" + items[x][1] + "</p><br><img src='img/shop/" + x + ".png' style='width: 50%'><br><p style='color: white'></span>Cost:<br>" + numberShort(game.coins) + "/30000 Coins<br>" + game.pets[44] + "/3 2-Headed snakes<br>" + game.pets[66] + "/1 Dimensional eye<br><br>Effects:<br>+700% XPBoost</p></center>"}
     if (x == 22) { document.getElementById("shopInfo").innerHTML = "<br><br><center><p style='color: white'><span style='font-size: 32px; font-weight: bold'>" + items[x][0] + "</span><br>You got " + game.items[x] + "/" + items[x][1] + "</p><br><img src='img/shop/" + x + ".png' style='width: 50%'><br><p style='color: white'></span>Cost:<br>" + numberShort(game.coins) + "/50000 Coins<br>" + game.pets[11] + "/10 Glowing eyeballs<br>" + game.pets[26] + "/5 Salamanders<br>-Reach level 75k<br>" + numberShort(game.highestLevel) + "/75k highest level<br><br>Effects:<br>/1.1 All button cooldowns</p></center>"}
     if (x == 23) { document.getElementById("shopInfo").innerHTML = "<br><br><center><p style='color: white'><span style='font-size: 32px; font-weight: bold'>" + items[x][0] + "</span><br>You got " + game.items[x] + "/" + items[x][1] + "</p><br><img src='img/shop/" + x + ".png' style='width: 50%'><br><p style='color: white'></span>Cost:<br>" + numberShort(game.coins) + "/75000 Coins<br>" + game.pets[34] + "/10 Eyeball spiders<br>" + game.pets[27] + "/3 Dark snakes<br>-Reach level 100k<br>" + numberShort(game.highestLevel) + "/100k highest level<br><br>Effects:<br>x2 Fighting rewards (Additive with itself, stacks with others)</p></center>"}
     if (x == 24) { document.getElementById("shopInfo").innerHTML = "<br><br><center><p style='color: white'><span style='font-size: 32px; font-weight: bold'>" + items[x][0] + "</span><br>You got " + game.items[x] + "/" + items[x][1] + "</p><br><img src='img/shop/" + x + ".png' style='width: 50%'><br><p style='color: white'></span>Cost:<br>" + numberShort(game.coins) + "/250k Coins<br>-Equip a pet stronger than Dark Blue Dragon<br>-Reach level 250k<br>-Have maxed 22 shop upgrades<br><br><br>After collecting some of the strongest pets in this dimension and controlling time to our level needs, the space-time continuum is breaking. In panic, you spot a portal ahead, but there's some writings on the frame. It tells you what do you need to own to proceed, else everything will collapse into oblivion. You do some preparations and activate the portal. Where could this lead?<br>(Unlocks a new feature)</p></center>"}
